    ...
    <div id="app">
        <x-container class="py-8">
            ...
            <x-form-section v-if="clients.length > 0">
                ...
                <x-slot name="description">
                    Aquí podras encontrar todos los clientes que has agregado
                </x-slot>
                ...
                methods: {
                    ...
                    store() {
                        ...
                        axios.post('/oauth/clients', this.createForm)
                            ...
                            this.createForm.errors = _.flatten(_.toArray(error.response.data.msg));
                            this.createForm.disabled = false;
                        });
                    },
                    show(client) {
                    ...
                    update() {
                        ...
                        axios.put('/oauth/clients/' + this.editForm.id, this.editForm)
                            ...
                            console.log(error.response.data);
                            this.editForm.errors = _.flatten(_.toArray(error.response.data.msg));
                            this.editForm.disabled = false;
                        });
